...
themeButton.addEventListener('click', () => {
    ...
    document.getElementById('our-team-index-1').style.backgroundImage = `url(${currentBackground})`
    document.getElementById('pole').style.backgroundImage = `url(${currentBackground})`
