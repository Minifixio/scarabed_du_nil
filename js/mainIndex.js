...
themeButton.addEventListener('click', () => {
    ...
    document.getElementById('hero-section').style.backgroundImage = `url(${currentBackground})`
    document.getElementById('our-team-index').style.backgroundImage = `url(${currentBackground})`
    document.getElementById('callto').style.backgroundImage = `url(${currentBackground})`
    document.getElementById('banner').style.backgroundImage = `url(${currentBackground})`
